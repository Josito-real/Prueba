...
const ME = 'p1'; // Andrea Salas — lead engineer
const TODAY = {
...
Object.assign(window, { PEOPLE, PROJECTS, TASKS, DEPS, ME, TODAY, NOTIFICATIONS, QUARTERS, OKRS, STATUS_META, PRIO_META, TASK_STATUS_META, ACCENTS });
