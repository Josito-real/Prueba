                ...
                {items.map(t=>{
                  ...
                  return (
                    <Card key={t.id} pad={12} onClick={()=>openProject(t.proj)}>
                      ...
                      <div style={{fontSize:13, fontWeight:500, lineHeight:1.35, marginBottom:10, textWrap:'pretty'}}>{t.title}</div>
...
const ExecView = () => (
  <div style={{padding:'20px 28px', maxWidth:1280, margin:'0 auto'}}>
    ...
    <Card title="Narrative" pad={20} style={{marginBottom:18}}>
      <div style={{fontSize:14, lineHeight:1.65, textWrap:'pretty', color:'var(--ink-2)', maxWidth:820}}>
...
Object.assign(window, { KanbanView, ListView, TableView, CalendarView, CapacityView, ExecView, InboxView });
